  ...
  return (
    <div className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-4">
        <h1 className="text-4xl font-extrabold text-stone-850 font-serif">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8 bg-white p-8 rounded-3xl border border-stone-200 shadow-sm">
          <div>
            ...
            <div className="space-y-4 text-sm text-stone-600">
              <div>
                <p className="font-bold text-stone-805">📍 Address</p>
              ...
              <div>
                <p className="font-bold text-stone-805">📞 Telephone</p>
                <p className="mt-1">+91 98765 43210</p>
              </div>

              <div>
                <p className="font-bold text-stone-805">✉️ Email Address</p>
                <p className="mt-1">hello@starstitcher.com</p>
              </div>

              <div>
                <p className="font-bold text-stone-850">🕒 Boutique Hours</p>
                <p className="mt-1">
        ...
        <div className="lg:col-span-7 bg-white p-8 rounded-3xl border border-stone-200 shadow-sm space-y-6">
          <div>
            ...
            <p className="text-stone-500 text-xs mt-1">We will respond within 24 business hours.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-stone-700 mb-1">Message Description</label>
              <textarea
                {...register('message')}
                rows={4}
